...
parser.add_argument('--in_img_dir', type=str, default='../Data/hrT2', help='Image dir of the LPBA images')
parser.add_argument('--out_img_dir', type=str, default='../Data/hrT2',
                    help='Output dir of preprocessed images and sketches')
parser.add_argument('--out_list_dir', type=str, default='../Data/SKETCH2ceT1', help='Output dir sketches list (test)')
...
if __name__ == "__main__":
    ...
    for sample in dataset:
        ...
        info_path = out_dir + 'shape_info_' + str(img_nr) + '.json'
        info_json = {}
        info_json['pat'] = img_nr
